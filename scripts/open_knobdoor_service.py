...
if __name__=='__main__':
	...
	# 	print(translation)	
	# 	print("Approach to the door")
	# 	recog_pos.pose.position.x = 0.679167519771
	# 	recog_pos.pose.position.y = 0.0045609356524
	# 	recog_pos.pose.position.z = 0.947054447124
	# 	grab_pose = geometry.multiply_tuples(geometry.pose(x=recog_pos.pose.position.x-translation[0],
	# 				y=recog_pos.pose.position.y-translation[1],
	# 				z=recog_pos.pose.position.z-translation[2],
	# 				ej=math.pi/2),
	# 				geometry.pose(ek=0.0))
